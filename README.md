...
MVVM要解决的问题:
 ...
 ```
操作dom,View-Model就是利用这些指令,将数据填充到View上面去展示的
...
注意点:
	v-bind的特殊写法,原因是在绑定某些特殊属性的时候,这些属性由固定的字符串加上一个变量来组成,那么这个时候,
	如果使用 :href='getnews'+id,那么id是找不到的,应该这样写 v-bind="{href:'getnews/'+id}"
